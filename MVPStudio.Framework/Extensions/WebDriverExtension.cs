    ...
    public static class WebDriverExtension
    {
        ...
        public static void WaitForPageLoaded(this IWebDriver driver, string pageTitle, int timeOutinSeconds = 10)
        {
            try
            {
                ...
                wait.Until((x) =>
                {
                    return (x.Title.Contains(pageTitle, StringComparison.OrdinalIgnoreCase));
                });
            }
            catch (WebDriverTimeoutException)
            {
        ...
        /// <summary>
        /// Wait for  a list of elements to loaded
        /// </summary>
        /// <param name="driver"></param>
        /// <param name="by"></param>
        /// <param name="timeOutinSeconds"></param>
        ...
        public static IList<IWebElement> WaitForElements(this IWebDriver driver, By ele, int timeOutinSeconds = 20)
        {
            ...
            try
            {
                ...
                list = (wait.Until(x => x.FindElements(ele)));
        ...
        {
            if (driver.SearchDataThroughPages<TKey, TValue>(searchOnEachPage, dataset) != 0)
            {
                return true;
            }
            else
        ...
        public static int SearchTableDataThroughPages(this IWebDriver driver, IDictionary<int, string> dataset)
        {
            ...
            return driver.SearchDataThroughPages<int, string>(tbodyElement.IsDataPresentInTable, dataset);
        }
        ...
        {
            var tbodyElement = driver.WaitForElement(By.TagName("tbody"));
            return driver.HasDataExisted<int, string>(tbodyElement.IsDataPresentInTable, dataset);
        }
    }
}